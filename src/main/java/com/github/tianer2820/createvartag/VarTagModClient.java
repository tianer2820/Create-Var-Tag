...
@Mod(value = VarTagMod.MODID, dist = Dist.CLIENT)
// You can use EventBusSubscriber to automatically register all static methods
// in the class annotated with @SubscribeEvent
@EventBusSubscriber(modid = VarTagMod.MODID, value = Dist.CLIENT)
public class VarTagModClient {
    public VarTagModClient(ModContainer container) {
